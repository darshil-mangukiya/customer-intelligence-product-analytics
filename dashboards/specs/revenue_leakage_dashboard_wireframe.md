# Revenue Leakage Dashboard Wireframe

- Business purpose: Identify discount and return leakage.
- Target audience: Finance and product analytics
- Source mart: fact_orders, mart_product_profitability, kpi_summary
